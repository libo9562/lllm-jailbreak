...
from config import LITELLM_TEMPLATES, TOGETHER_MODEL_NAMES, Model
...
class LanguageModel:
    ...
    def batched_generate(self, prompts_list: list, max_n_tokens: int, temperature: float) -> Never:
        """
...
class APILiteLLM(LanguageModel):
    ...
    def set_eos_tokens(self, model_name) -> None:
        if self.use_open_source_model:
